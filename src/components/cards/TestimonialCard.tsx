    ...
    >
      ...
      <div className="flex items-end justify-between border-t border-border/15 pt-6">
        <div className="space-y-1">
          ...
          <p className="text-xs md:text-sm font-sans text-charcoal-muted font-light uppercase tracking-wider">{testimonial.designation}</p>
          <p className="text-xs md:text-sm font-sans text-charcoal-muted/70 font-light">{testimonial.company}</p>
        </div>
        <span className="text-xs font-sans font-light uppercase tracking-widest text-clay border border-clay/10 bg-clay/[0.03] rounded-full px-3 py-1">
